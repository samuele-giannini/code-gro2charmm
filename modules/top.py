                ...
                # extend system.molecules
                    ...
                    if fu == 2:
                        if curr_sec=='pairtypes':
                            pair.atype1 = ai
                            pair.atype2 = aj
                            qq, qi, qj, v, w = list(map(float, fields[3:8]))
                            pair.gromacs = {'param': {
                                'lje' : None,
                                'ljl' : None,
                                'lje14' : w,
...
class SystemToGroTop(object):
    ...
    formats = {
        'atomtypes'      : '{:<7s} {:3s} {:8.4f}   {:6.3f}   {:3s}    {:6.4f} {:12.6f}\n',
        'atoms'          : '{:6d} {:>10s} {:6d}   {:6s} {:6s} {:6d} {:10.6f} {:8.4f}\n',
        'atoms_nomass'   : '{:6d} {:>10s} {:6d} {:6s} {:6s} {:6d} {}\n',
        'nonbond_params' : '{:20s}  {:20s}  {:1d}  {}  {}\n',
        'bondtypes'      : '{:5s}  {:5s}  {:1d}  {}  {}\n',
        'bonds'          : '{:3d}  {:3d}   {:1d}\n',
        'bonds_ext'      : '{:3d}  {:3d}   {:1d}   {:10.4f} {:12.4f}\n',
        'settles'        : '{:3d}  {:3d}  {} {}\n',
        'virtual_sites3' : '{:3d}  {:3d}  {:3d}  {:3d}   {:1d}  {}  {}\n',
        'exclusions'     : '{:3d}  {}\n',
        'pairtypes'      : '{:6s} {:6s}   {:d}    {:.13f}     {:.13f}\n',
        'pairs'          : '{:3d} {:3d}   {:1d} {:6.3f} {:6.3f} {:6.3f} {:8.4f} {:10.6f}\n',
        'angletypes_1'   : '{:>8s} {:>8s} {:>8s} {:1d}    {}    {}\n',
        'angletypes_5'   : '{:>8s} {:>8s} {:>8s} {:1d}    {}    {}    {}    {}\n',
        'constrainttypes': '{:6s} {:6s} {:1d}    {}\n',
        'angles'         : '{:3d} {:3d} {:3d}   {:1d}\n',
        'angles_ext'     : '{:3d} {:3d} {:3d}   {:1d} {:10.4f} {:12.4f}\n',
        'dihedraltypes'  : '{:6s} {:6s} {:6s} {:6s}   {:1d}    {}    {}    {:1d}\n',
        'dihedrals'      : '{:3d} {:3d} {:3d} {:3d}   {:1d}\n',
        'dihedrals_ext'  : '{:3d} {:3d} {:3d} {:3d}   {:1d}    {:10.4f} {:10.4f}   {:1d}\n',
        'impropertypes_2'  : '{:6s} {:6s} {:6s} {:6s}   {:1d} {} {} \n',
        'impropertypes_4'  : '{:6s} {:6s} {:6s} {:6s}   {:1d} {} {} {:2d}\n',
        'impropers'      : '{:3d} {:3d} {:3d} {:3d}   {:1d}\n',
        'impropers_2'  : '{:3d} {:3d} {:3d} {:3d}   {:1d}    {:10.4f} {:10.4f} \n',
        'impropers_4'  : '{:3d} {:3d} {:3d} {:3d}   {:1d}    {:10.4f} {:10.4f} {:2d}\n',
    }
    ...
    toptemplate = """
            ...
            *DEFAULTS*
            [ atomtypes ]
            ; name       mass       charge  ptype  sigma      espilon
            *ATOMTYPES*
            [ nonbond_params ]
            *NONBOND_PARAM*
            [ bondtypes ]
    ...
    def _make_pairs(self,m):
        ...
        for pr in m.pairs:
            ...
            fu = pr.gromacs['func']
            qq, qi, qj = pr.gromacs['param']['QQ'], pr.gromacs['param']['qi'], pr.gromacs['param']['qj']
            v, w = pr.gromacs['param']['ljl14'], pr.gromacs['param']['lje14']
            line = self.formats['pairs'].format(p1, p4, fu, qq, qi, qj, v, w)
            result.append(line)
